...
public class NamespaceClaim {
	...
	private String kind = "NamespaceClaim";
	private V1ObjectMeta metadata = null;
	private V1ResourceQuotaSpec spec = null;
	private NamespaceClaimStatus status = null;
	...
	public NamespaceClaimStatus getStatus() {
		return status;
	}
	public void setStatus(NamespaceClaimStatus status) {
		this.status = status;
	}
