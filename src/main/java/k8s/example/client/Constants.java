...
//	public static final String USER_DELETE_CRON_EXPRESSION = "0 0/5 * 1/1 * ? *"; // every 5 mins for test
	...
	public static final String OTP_VERIFICATION_CONTENTS = "<!DOCTYPE html>\r\n" + 
			...
			"<head>\r\n" + 
			"    <meta charset=\"UTF-8\">\r\n" + 
			"    <title>[�씤利앸쾲�샇 : %%otpCode%%] �씤利� 踰덊샇瑜� �븣�젮�뱶由쎈땲�떎.</title>\r\n" + 
			"</head>\r\n" + 
			"<body>\r\n" + 
			...
			"                �븞�뀞�븯�꽭�슂? <br>\r\n" + 
			"                HyperCloud瑜� �씠�슜�빐 二쇱뀛�꽌 媛먯궗�빀�땲�떎. <br>\r\n" + 
			"                濡쒓렇�씤 �솕硫댁뿉�꽌 �씤利앸쾲�샇瑜� �엯�젰�빐 二쇱꽭�슂. <br>\r\n" + 
			"                媛먯궗�빀�땲�떎. <br>\r\n" + 
			"            </p>\r\n" + 
			"        </div>\r\n" + 
			"    </section>\r\n" + 
	...
	public static final String TRIAL_TIME_OUT_CONTENTS = "<!DOCTYPE html>\r\n" + 
			...
			"<head>\r\n" + 
			"    <meta charset=\"UTF-8\">\r\n" + 
			"    <title>HyperCloud �꽌鍮꾩뒪 湲곌컙 留뚮즺 �븞�궡 �븣由�</title>\r\n" + 
			"</head>\r\n" + 
			"<body>\r\n" + 
			...
			"        <div style=\"margin: 0;\">\r\n" + 
			"            <p style=\"font-size: 1rem; font-weight: bold; color: #333333; line-height: 3rem; letter-spacing: 0; border-bottom: #c5c5c8 0.06rem solid;\">\r\n" + 
			"                HyperCloud �꽌鍮꾩뒪 湲곌컙 留뚮즺 �븞�궡 �븣由�\r\n" + 
			"            </p>\r\n" + 
			"        </div>\r\n" + 
			"    </header>\r\n" + 
			"    <section>\r\n" + 
			...
			"            <p style=\"line-height: 1.38rem;\">\r\n" + 
			"                �븞�뀞�븯�꽭�슂? <br>\r\n" + 
			"                TmaxCloud瑜� �씠�슜�빐 二쇱뀛�꽌 媛먯궗�빀�땲�떎. <br>\r\n" + 
			"                怨좉컼�떂猿섏꽌 �궗�슜以묒씤 Trial �꽌鍮꾩뒪媛� <span style=\"color: #F26868;\">%%TRIAL_END_TIME%%</span>�뿉 留뚮즺�맗�땲�떎. <br>\r\n" + 
			"                Trial �꽌鍮꾩뒪 �씠�슜 留뚮즺 �떆 �궗�슜以묒씤 �꽕�엫�뒪�럹�씠�뒪�쓽 由ъ냼�뒪�뒗 紐⑤몢 �궘�젣�맗�땲�떎. <br>\r\n" + 
			"                Trial �꽌鍮꾩뒪 留뚮즺 湲곌컙 �씠�쟾�뿉 <span style=\"color: #187EE3;\">�쑀猷� �꽌鍮꾩뒪濡� �쟾�솚</span> �샊�� 由ъ냼�뒪瑜� 諛깆뾽�빐二쇱떆湲� 諛붾엻�땲�떎. <br>\r\n" + 
			"                <br>\r\n" + 
			"                媛먯궗�빀�땲�떎. <br>\r\n" + 
			"                TmaxCloud �뱶由�.\r\n" + 
			"            </p>\r\n" + 
	...
	public static final String TRIAL_SUCCESS_CONFIRM_MAIL_CONTENTS = "<!DOCTYPE html>\r\n" + 
			...
			"<head>\r\n" + 
			"    <meta charset=\"UTF-8\">\r\n" + 
			"    <title>HyperCloud �꽌鍮꾩뒪 �떊泥� �듅�씤 �셿猷�</title>\r\n" + 
			"</head>\r\n" + 
			"<body>\r\n" + 
			...
			"            </p>\r\n" + 
			"            <p style=\"line-height: 1.38rem;\">\r\n" + 
			"                怨좉컼�떂�쓽 Trial �꽌鍮꾩뒪 �떊泥��씠 �꽦怨듭쟻�쑝濡� �듅�씤�릺�뿀�뒿�땲�떎. <br>\r\n" + 
			"                吏�湲� 諛붾줈 �떚留μ뒪�쓽 �냼�봽�듃�썾�뼱�� 寃�利앹쓣 嫄곗튇 �삤�뵂�냼�뒪 �꽌鍮꾩뒪瑜� 寃고빀�븳 �겢�씪�슦�뱶 �뵆�옯�뤌, <br>\r\n" + 
			"                HyperCloud瑜� �씠�슜�빐 蹂댁꽭�슂. <br>\r\n" + 
			"                <br>\r\n" + 
			"                �꽕�엫�뒪�럹�씠�뒪 �씠由� : <span style=\"font-weight: 600;\">%%NAMESPACE_NAME%%</span> <br>\r\n" + 
			"                Trial 湲고븳 : %%TRIAL_START_TIME%% ~ %%TRIAL_END_TIME%% <br>\r\n" + 
			"                <br>\r\n" + 
			"                由ъ냼�뒪 �젙蹂� <br>\r\n" + 
			"                -CPU : 1 Core <br>\r\n" + 
			"                -Memory : 1 GIB <br>\r\n" + 
			...
			"                <br>\r\n" + 
			"<!--                <span style=\"font-weight: 600;\">�듅�씤�궗�쑀</span> <br>-->\r\n" + 
			"                <br>\r\n" + 
			"\r\n" + 
			"                媛먯궗�빀�땲�떎. <br>\r\n" + 
			"                TmaxCloud �뱶由�.\r\n" + 
			...
			"                <a href=\"https://console.tmaxcloud.com\">Tmax Console 諛붾줈媛�湲� ></a>\r\n" + 
			"            </p>\r\n" + 
			"        </div>\r\n" + 
			"    </section>\r\n" + 
			"</div>\r\n" + 
	...
	public static final String TRIAL_FAIL_CONFIRM_MAIL_CONTENTS = "<!DOCTYPE html>\r\n" + 
			...
			"<head>\r\n" + 
			"    <meta charset=\"UTF-8\">\r\n" + 
			"    <title>HyperCloud �꽌鍮꾩뒪 �떊泥� 寃곌낵 �븣由�</title>\r\n" + 
			"</head>\r\n" + 
			"<body>\r\n" + 
			"<div style=\"border: #c5c5c8 0.06rem solid; border-bottom: 0; width: 42.5rem; height: 43.19rem; padding: 0 1.25rem\">\r\n" + 
			"    <header>\r\n" + 
			...
			"            <p style=\"line-height: 1.38rem;\">\r\n" + 
			"                �븞�뀞�븯�꽭�슂? TmaxCloud �엯�땲�떎. <br>\r\n" + 
			"                TmaxCloud�뿉 愿��떖�쓣 媛��졇 二쇱뀛�꽌 媛먯궗�빀�땲�떎. 怨좉컼�떂�쓽 �꽌鍮꾩뒪 �떊泥��쓣 寃��넗�븯���쑝硫�, <br>\r\n" + 
			"                洹� 寃곌낵濡� 怨좉컼�떂�쓽 �꽌鍮꾩뒪 �떊泥��씠 �듅�씤�릺吏� �븡�븯�쓬�쓣 �븣�젮�뱶由쎈땲�떎. <br>\r\n" + 
			"                鍮꾩듅�씤 �궗�쑀�뒗 �븘�옒�� 媛숈뒿�땲�떎. <br>\r\n" + 
			"                <br>\r\n" + 
			"                <span style=\"font-weight: 600;\">鍮꾩듅�씤 �궗�쑀</span>\r\n" + 
			"                <p>%%FAIL_REASON%%</p>\r\n" + 
			"                <br>\r\n" + 
			"                <br>\r\n" + 
			"                媛먯궗�빀�땲�떎. <br>\r\n" + 
	...
	public static final String VERIFY_MAIL_CONTENTS = "<!DOCTYPE html>\r\n" + 
			...
			"        <div style=\"margin: 0;\">\r\n" + 
			"            <p style=\"font-size: 1rem; font-weight: bold; color: #333333; line-height: 3rem; letter-spacing: 0; border-bottom: #c5c5c8 0.06rem solid;\">\r\n" + 
			"                [�씤利앸쾲�샇 : %%verifyNumber%%] �씠硫붿씪�쓣 �씤利앺빐 二쇱꽭�슂.\r\n" + 
			"            </p>\r\n" + 
			"        </div>\r\n" + 
			"    </header>\r\n" + 
			"    <section>\r\n" + 
			...
			"                �븞�뀞�븯�꽭�슂? <br>\r\n" + 
			"                TmaxCloud瑜� �씠�슜�빐 二쇱뀛�꽌 媛먯궗�빀�땲�떎. <br>\r\n" + 
			"                媛��엯 �솕硫댁뿉�꽌 �씤利앸쾲�샇瑜� �엯�젰�빐 二쇱꽭�슂. <br>\r\n" + 
			"                媛먯궗�빀�땲�떎. <br>\r\n" + 
			"            </p>\r\n" + 
			"        </div>\r\n" + 
			"    </section>\r\n" + 
